...
CV = CountVectorizer(lowercase = False, stop_words = None, max_features=110000, ngram_range=(1,2), encoding="mbcs", binary=True)
...
rezultat.to_csv("../Submission_Data/MNB_Submission8.csv", index = False)
