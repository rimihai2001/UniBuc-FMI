...
CV = CountVectorizer(ngram_range=(1,6), encoding="mbcs", binary=True, analyzer="char", lowercase = False)
...
rfc_200.fit(sentences_CV, all_labels_language)
...
rezultat.to_csv("../Submission_Data/RFC_200_Submission16.csv", index = False)
