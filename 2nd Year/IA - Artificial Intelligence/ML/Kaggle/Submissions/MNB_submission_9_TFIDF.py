...
CV = TfidfVectorizer(lowercase = False, stop_words = None, max_features=80000, ngram_range=(1,2), encoding="mbcs", binary=True)
...
NB2 = MultinomialNB(alpha=0.05)
NB2.fit(sentences_CV, all_labels_language)
...
rezultat.to_csv("../Submission_Data/MNB_TFIDF_Submission9.csv", index = False)
