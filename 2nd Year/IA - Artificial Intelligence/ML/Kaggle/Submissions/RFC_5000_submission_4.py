...
rfc_5000 = RandomForestClassifier(n_estimators=5000)
rfc_5000.fit(sentences_CV, all_labels_language)
prediction=rfc_5000.predict(test_data)
...
rezultat.to_csv("../Submission_Data/RFC_5000_Submission4.csv", index = False)
