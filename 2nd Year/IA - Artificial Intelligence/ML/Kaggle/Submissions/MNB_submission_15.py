...
CV = CountVectorizer(ngram_range=(3,7), encoding="mbcs", binary=True, analyzer="char", lowercase = False)
...
rezultat.to_csv("../Submission_Data/MNB_Submission15.csv", index = False)
