...
CV = CountVectorizer(lowercase = False, stop_words = None, max_features=80000, ngram_range=(1,2), encoding="mbcs", binary=True)
...
rezultat.to_csv("../Submission_Data/MNB_Submission7.csv", index = False)
