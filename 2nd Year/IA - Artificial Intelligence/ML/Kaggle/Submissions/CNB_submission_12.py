...
CV = CountVectorizer(ngram_range=(1,8), encoding="mbcs", binary=True, analyzer="char", lowercase = False)
...
rezultat.to_csv("../Submission_Data/CNB_Submission12.csv", index = False)
